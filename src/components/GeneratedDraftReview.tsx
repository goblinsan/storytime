  ...
  if (selectedDraftId) {
    ...
    return (
      <div className="draft-review-container">
        ...
        {isGenerated && (
          <div className="draft-status-banner banner-generated">
            ...
            <div className="banner-content">
              ...
              <p>
                Generated by local LLM and pending operator review. Review the lore draft below and click <em>Accept Draft</em> when ready to stage for canon promotion.
              </p>
            </div>
          </div>
        )}
        {isAccepted && (
          <div className="draft-status-banner banner-accepted">
            ...
            <div className="banner-content">
              ...
              <p>
                This draft has been reviewed and accepted.
                {selectedDraft.promotedAt ? (
                  <> <strong>Promoted to Universe Canon on {new Date(selectedDraft.promotedAt).toLocaleString()}.</strong></>
                ) : (
                  <> Click <em>Promote to Canon</em> above to materialize its world brief, characters, locations, factions, and timeline events into canonical tables.</>
                )}
              </p>
              {promotionResult && (
        ...
        {isRejected && (
          <div className="draft-status-banner banner-rejected">
            ...
            <div className="banner-content">
              ...
              <p>
                This draft was rejected during operator review or gate validation. It will not be merged into universe canon.
              </p>
            </div>
          </div>
        )}
        ...
        {/* Universe Lore Artifact Export Section */}
        <div className="draft-section export-section">
          <div className="section-heading">
            <FontAwesomeIcon icon={faFileCode} />
            <h2>Universe Lore Artifact Export</h2>
          </div>
            ...
            <div className="export-container accepted-export">
              <div className="export-description">
                ...
                <div className="export-buttons">
                  ...
                  >
                    <FontAwesomeIcon icon={faCopy} /> Copy Artifact JSON
                  </button>
                  <button
                    className="export-btn secondary-export-btn"
                    onClick={() => handleCopy(payloadJson, 'Universe lore payload')}
                  >
                    <FontAwesomeIcon icon={faCopy} /> Copy Lore Payload
                  </button>
                  <button
    ...
    <div className="draft-review-container">
      <div className="draft-list-header">
        <div className="draft-list-title">
          ...
          <p>Inspect, review, or promote model-generated lore artifacts into canonical universe tables</p>
        </div>
      ...
      {loadingList ? (
        ...
        <div className="drafts-grid">
          {drafts.map((draft) => {
            const worldName =
              draft.payload?.worldBrief?.name ||
              (draft.artifactType ? draft.artifactType.replace(/_/g, ' ').toUpperCase() : 'Universe Lore Draft');
