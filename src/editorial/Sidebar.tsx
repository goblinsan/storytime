...
const UNIVERSE_SECTIONS: Array<{
  ...
  { id: 'technologies', label: 'Technologies', icon: faMicrochip, count: (u) => u.canonCounts?.technologies },
  { id: 'arcs', label: 'Arcs', icon: faDiagramProject, count: (u) => u.canonCounts?.arcs },
